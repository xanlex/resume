...
\begin{rSubsection}{Macquarie Bank Ltd.}{May, 2015 - April, 2017}{Network Security Engineer}{Houston, TX}
  \begin{itemize}
        \item Built out and supported private and public cloud mail delivery system built around F5's LTM load balancers and GTM DNS servers.
        \item Third level support for F5 LTM, GTM \& APM products.
...
\begin{rSubsection}{Texas Children's Hospital}{May, 2011 - October, 2011}{Enterprise Systems Engineer - Contract}{Houston, TX}
  \begin{itemize}
    ...
    %    \item Third level support for MS Exchange infrastructure including Server and Storage clusters, Exchange Transport, Client Access, Mail Storage Group and database troubleshooting and restoration. Authentication and authorization for email submission and relay, SPAM filtering and Transport encryption - TLS enforcement. Mailbox rebalancing across storage groups and databases. Mailbox recovery and litigation support.
        \item Third level support for RightFax, Blackberry, ActiveSync, MAPI, and RPC-over-HTTP clients.
        \item Integrated Wifi authentication with MS Active Directory through RADIUS \& 802.1x capable APs.
        \item Automated common MS Exchange and MS Outlook administrative tasks through VBScript and PowerShell.
  \end{itemize}
\end{rSubsection}
%------------------------------------------------
...
%{At this global professional services firm, I was the lead for Microsoft Active Directory, Exchange, ISA and Windows Server platforms. I also:}
  \begin{itemize}
	...
	\item Planned and ran an Exchange 2007 upgrade that involved a move to VMWare virtual hosts and a new storage network around EMC's Clariion systems.
...
%{As the technical lead at this management consulting firm, I deployed a majority of systems and networks.}
  \begin{itemize}
	\item Designed a highly available, multi-office WAN through dedicated inter-office frame relay links, backed by IPSec VPNs over the Internet.
 	\item Led all Network, MS Active Directory and MS Exchange-related work.
