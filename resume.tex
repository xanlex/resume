...
Information security architect with broad experience building, protecting and automating distributed systems. I am looking to use my security and technical expertise in a pre-sales engineering role.\end{rSubsection}
%------------------------------------------------
...
\begin{rSubsection}{Digital Crafts}{September, 2017 - January, 2017}{Student}{Houston, TX} 
...
\begin{rSubsection}{Macquarie Bank Ltd.}{May, 2015 - April, 2017}{Engineer}{Houston, TX}
  \begin{itemize}
        \item Built and supported private and public cloud web-application delivery systems around F5 LTM load balancing proxies.
        \item Secured access to public applications using F5 APM and Palo Alto firewalls.
...
%{As the technical lead at this management consulting firm, I deployed a majority of systems and networks.}
  \begin{itemize}
        \item Led all MS Active Directory and MS Exchange work.
        \item Worked with consultants to build an Exchange-integrated Avaya VoIP system.
        \item lead all MS Exchange and MS Active Doperations projects.
